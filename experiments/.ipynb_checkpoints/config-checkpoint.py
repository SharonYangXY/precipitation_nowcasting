...
__C.GLOBAL.MODEL_SAVE_DIR = '/home/sunpeng/data/yiyi/save'
...
# cpu
# __C.RAIN.ROOT = "D:\\Precipitation\\data\\1h_GPM\\numpy"
...
# GPU
__C.RAIN.ROOT = "/home/sunpeng/data/yiyi/precipitation/numpy"
__C.RAIN.MultiChannelROOT = "/home/sunpeng/data/yiyi/precipitation/numpy"
__C.RAIN.TRAIN_file_NAME = "TrainDataset.txt"
__C.RAIN.VAL_file_NAME = "ValDataset.txt"
__C.RAIN.TEST_file_NAME = "TestDataset.txt"
__C.RAIN.DATA_LIST_file = "DataList.txt"

__C.RAIN.TYPH_TRAIN_file_NAME = "TrainDataset_1h.txt"
__C.RAIN.TYPH_VAL_file_NAME = "ValDataset_1h.txt"
__C.RAIN.TYPH_TEST_file_NAME = "TestDataset_1h.txt"
...
__C.HKO.EVALUATION.THRESHOLDS = np.array([0.5, 2, 5, 10, 30])  # ([0.5, 5, 20, 50])
__C.HKO.EVALUATION.CENTRAL_REGION = (0, 0, 600, 500)  # (120, 120, 360, 360)
__C.HKO.EVALUATION.BALANCING_WEIGHTS = (1, 1, 1, 1, 1, 1)  # (1, 5, 10, 20, 30)  # (1, 1, 2, 5, 10, 30)
#
