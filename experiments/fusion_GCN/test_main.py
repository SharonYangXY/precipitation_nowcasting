...
from experiments.gcn_test import test
import os
...
# Here, there has two ways for GCN. 
# One is both existed in image and typh encoder; another is only existed in the image encoder.
# Note it!!!!!!!!!!!!!!!
...
folder_name = os.path.split(os.path.dirname(os.path.abspath(__file__)))[-1] + "_no_seed_double_GCN_0505_gcn0_5_sssss"
...
model_path = '/home/sunpeng/data/yiyi/save/fusion_GCN_05_no_seed_double_GCN_0502_gcn0_5/models/typh_encoder_forecaster_8.pth'
