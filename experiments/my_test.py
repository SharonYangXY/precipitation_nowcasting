...
def test(train_dataset, test_dataset, val_dataset, encoder_forecaster, optimizer, criterion, lr_scheduler,
    ...
    final_print_file = open(os.path.join(root, "ConvLstm_final_output.txt"), "w")
    ...
    val_loader = DataLoaderX(dataset=test_dataset, batch_size=batch_size, shuffle=False, pin_memory=True,
    num_workers=8)
